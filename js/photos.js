    ...
    try {
        ...
        Object.values(groups).forEach(g => {
            ...
            const icon = L.divIcon({
                className: '',
                html: `<div style="background:white;border:2px solid #ff9800;border-radius:50%;width:28px;height:28px;display:flex;align-items:center;justify-content:center;font-size:14px;box-shadow:0 1px 4px rgba(0,0,0,0.3);cursor:pointer;">📷</div>`,
                iconSize: [28, 28],
                iconAnchor: [14, 14],
            });
