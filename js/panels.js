...
async function loadPanels() {
    try {
        ...
        const result = await apiCall('getPanels', params);
...
window.savePanel = async function(lat, lng) {
    ...
    try {
        const result = await apiCall('addPanel', {
...
window.deletePanel = async function(panelId) {
    ...
    try {
        const result = await apiCall('deletePanel', { panelId: panelId });
...
window.saveEditPanel = async function(panelId) {
    ...
    try {
        const result = await apiCall('updatePanel', { panelId: panelId, text: newText });
